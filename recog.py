    ...
    def get_frame(self, count):
        ...
        while True:
            ...
            if face_extractor(frame) is not None:
                ...
                file_name_path = 'C:\\Users\\hp\\PycharmProjects\\faces\\user' + str(count) + '.jpg'
                cv2.imwrite(file_name_path, face)
                ret, jpeg = cv2.imencode('.jpg', cv2.putText(face, str(count), (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 0), 2))
                print(count)
